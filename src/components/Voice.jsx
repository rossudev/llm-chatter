...
const Voice = ({setMedia, handleVoice, media, isClicked}) => {
    ...
    return (
      <div
        className="min-w-full mb-1 pt-3 pl-3 bg-morbius-300 rounded-3xl bg-gradient-to-tl from-morbius-500 shadow-2xl"
      >
        <div
        ...
        >
          ...
          { !isClicked &&
            <div className="text-4xl mt-10 mb-8 text-black">
                <span className="minute">Recorded Length: {minute}</span>
                <span>:</span>
            ...
            >
              <div>
                ...
                { ( media && !isClicked && !isActive ) &&
                    <button
                    className="bg-marcelin-500 text-black hover:bg-marcelin-800 ml-6 mt-2"
                    style={{
                        padding: "0.8rem 2rem",
                        border: "none",
                        fontSize: "1rem",
