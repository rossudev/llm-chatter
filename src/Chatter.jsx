    ...
    <dataContext.Provider value={{ componentList, setComponentList, chatCount, setChatCount, chosenAnthropic, chosenGoogle, chosenGrokAI, chosenDeepseekAI, chosenOllama, chosenOpenAI, clientJWT, checkedIn, setClientJWT, setCheckedIn }}>
      <div>
        <Spring
          ...
          delay={400}>
          {styles => (
            <animated.div style={styles} className="w-[50%] smolscreen:w-full text-aro-100 mx-auto cursor-default bg-vonCount-600 bg-gradient-to-tl from-vonCount-700 rounded-3xl font-bold p-2 flex items-center justify-center">
                    ...
                    <>
                      <div className="grid gap-2 grid-cols-3 mt-6 mb-2">
                        <Spring
                          ...
                          delay={200}>
                          {styles => (
                            <animated.div onClick={() => { debouncedMakeNewChat(chatType); }} style={styles} className="border-solid border border-aro-800 self-start text-black mx-auto hover:bg-nosferatu-300 cursor-default bg-nosferatu-200 rounded-3xl text-2xl font-bold p-4 flex items-center justify-center mb-2 bg-gradient-to-tl from-nosferatu-500 hover:from-aro-600 cursor-pointer hover:border-2">
                        ...
                        {(chatType.includes("OpenAI") && (!componentList.some(container => container.chatType.includes("(Voice)")))) ?
                          <>
                            <Spring
                              ...
                              delay={300}>
                              {styles => (
                                <animated.div onClick={() => { debouncedMakeNewChat("(Voice)"); }} style={styles} className="border-solid border border-aro-800 self-start text-black mx-auto hover:bg-nosferatu-300 cursor-default bg-nosferatu-200 rounded-3xl text-2xl font-bold p-4 flex items-center justify-center mb-1 bg-gradient-to-tl from-nosferatu-500 hover:from-aro-600 cursor-pointer hover:border-2">
