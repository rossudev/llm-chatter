...
var normalizeArray = function (data, m, downsamplePeaks, memoize) {
    if (downsamplePeaks === void 0) { downsamplePeaks = false; }
    if (memoize === void 0) { memoize = false; }
    var cache, mKey, dKey;
    if (memoize) {
        mKey = m.toString();
...
export const WavRenderer = {
     ...
     */
    drawBars: function (canvas, ctx, data, color, pointCount, barWidth, barSpacing, center) {
        if (pointCount === void 0) { pointCount = 0; }
        if (barWidth === void 0) { barWidth = 0; }
        if (barSpacing === void 0) { barSpacing = 0; }
